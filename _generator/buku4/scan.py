# -*- coding: utf-8 -*-
# Scan posisi heading di PDF final Lidya -> page_real.json untuk DOCX manual TOC.
# TOC Buku 4 tanpa leader & judul title-case; isi judul UPPERCASE -> dipakai utk bedakan TOC vs isi.
import re, json, sys
from pypdf import PdfReader
sys.path.insert(0, "Joki-tugas-/_generator/buku4")
import konten

PDF = "Joki-tugas-/FINAL/Buku 4 - Lidya Ellen Febriasalsa - PKN - FINISH.pdf"
OUT = "Joki-tugas-/_generator/buku4/build_lidya/page_real.json"
r = PdfReader(PDF)
n = len(r.pages)
...
# bab pages: cari halaman yang memuat 'BAB n' + judul UPPERCASE (heading isi, bukan entri TOC title-case)
page_real = {}
bab_pages = {}
for b in konten.BAB:
...
# daftar pustaka (heading uppercase di isi)
